...
CREATE TABLE recetas (id SERIAL PRIMARY KEY, id_usuario INTEGER, descripcion TEXT NOT NULL, tiempo_preparacion INTEGER NOT NULL, categoria VARCHAR(20) NOT NULL, likes INTEGER DEFAULT 0, dislikes INTEGER DEFAULT 0, FOREIGN KEY (id_usuario) REFERENCES usuarios(id));
...
INSERT INTO recetas (id_usuario, descripcion, tiempo_preparacion, categoria, likes, dislikes) VALUES (1, 'Hago una pizza casera simple de muzzarela', 35, 'comida', 5, 7);
...
curl -X POST \
-d '{"id_usuario":1,"descripcion":"Tarta de verdura","tiempo_preparacion":30,"categoria":"comida","likes":0,"dislikes":0}' \
-H "Content-Type: application/json" \
...
curl -X PUT \
-H "Content-Type: application/json" \
-d '{"descripcion": "Pizza casera mejorada","tiempo_preparacion": 40,"categoria": "comida","likes": 10,"dislikes": 2}' \
